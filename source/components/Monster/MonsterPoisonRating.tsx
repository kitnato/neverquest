...
import { poison, poisonMagnitude } from "@neverquest/state/reserves";
    ...
    return (
      ...
      >
              ...
              <PopoverBody>
                <DetailsTable>
                  ...
                  <tr>
                    ...
                    <td>
                      <span>{formatNumber({ format: "time", value: poisonValue })}</span>
                    </td>
                  </tr>
                </DetailsTable>
              </PopoverBody>
        ...
        >
          <span>
            {formatNumber({
              value: poisonChanceValue * poisonMagnitudeValue * poisonValue,
            })}
          </span>
        </OverlayTrigger>
      </IconDisplay>
