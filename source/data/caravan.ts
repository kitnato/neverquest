...
> = {
  alchemist: {
    ...
    monologues: {
      ...
      51: "Come across any arcane writs lately?",
  ...
  merchant: {
    ...
    monologues: {
      ...
      70: "Dark portents signal that dark tides are coming.",
      ...
      101: "Please go back to where you came from.",
      110: "This is all wrong. I don't understand.",
      120: "Why? Darkness never-ending ...",
      130: "Inescapable. Unfathomable. Inside everything.",
      140: "Please ... the pain ...",
      150: "All is truly lost ...",
    },
    price: 1,
    requiredStage: 0,
  },
