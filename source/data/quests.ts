...
> = {
  ...
  exhausting: {
    description: "Be too exhausted to attack, dodge, parry or block.",
    progression: [1, 3, 10, 25, 50],
    requiresTracking: true,
    title: "Out of breath",
  },
  ...
  killing: {
    ...
    progression: [1, 3, 10, 25, 50, 100, 250],
    requiresTracking: true,
    title: "Monstrocide",
  },
  killingBoss: {
  ...
  potions: {
    description: "Consume the witch's concoctions.",
    progression: [1, 3, 10, 25],
    requiresTracking: true,
  ...
  shocking: {
    description: "Inflict shocking ailment.",
    progression: [1, 3, 10, 25, 50, 100],
    requiresTracking: true,
    title: "Raiden",
  },
