...
import { ReactComponent as IconArmorProtection } from "@neverquest/icons/armor-protection.svg";
...
export function ArmorOptions() {
  ...
  const maximumArmorLevel = levelValue + 3;
  ...
  return (
    <>
      <Stack className="mx-auto" gap={3}>
        ...
        {staminaCost > 0 && (
          <IconDisplay
            contents={skillDodgeValue ? <DodgePenalty staminaCost={staminaCost} /> : LABEL_UNKNOWN}
